...
def canonical_trafo(coords_xyz):
    """ Transforms the given real xyz coordinates into some canonical frame.
        ...
        Inputs:
            coords_xyz: BxNx3 matrix, containing the coordinates for each of the N augmented_keypoints
    """
    with tf.variable_scope('canonical-trafo'):
        ...
        # 2. Rotate and scale augmented_keypoints such that the root bone is of unit length and aligned with the y axis
        ...
        # 3. Rotate augmented_keypoints such that rotation along the y-axis is defined
